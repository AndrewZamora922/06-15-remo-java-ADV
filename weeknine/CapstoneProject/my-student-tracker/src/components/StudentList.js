        ...
        <React.Fragment>
          {students.map((student) => (
            <div
              ...
              key={student.id}
            >
              <div className="flex-auto text-left font-bold px-4 py-2 m-2">

                <p className="text-gray-900">Student: {student.name}
                </p>
                <p className="text-gray-600"> Math: {student.math}
                </p>
                <span className="text-gray-600"> Science: {student.science}
                </span>
                <p className="text-gray-600"> Overall: {student.grade}
                </p>
              </div>
